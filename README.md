...
　　[http://github.com/showmylym/LYMDraggableView](http://github.com/showmylym/LYMDraggableView)    
　　  
　　  
　　以下是控件演示：    
![图片2-12](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-12.gif)
![图片2-13](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-13.gif)
![图片2-14](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-14.gif)

　　纵观iOS App市场，有类似实现效果的应用不少，如下截图：    
####*优酷视频iPad客户端*管理离线视频
![图片2-1](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-1.gif)
####*微信讨论组*增删人员
![图片2-2](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-2.gif)  
####*有信收藏栏*
![图片2-3](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-3.gif)
####*有信照片墙*
![图片2-4](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-4.gif)
###大致工作流程为：    
...
####下图为正常状态下各个部分的有效区域：    
![图片2-5](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-5.png)

####下图为编辑状态下各个部分的有效区域：    
![图片2-6](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-6.png)
...
![图片2-7](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-7.png)
...
![图片2-8](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-8.png)
...
######注释的样子
![图片2-9](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-9.png)
######快速查看方法说明的样子
![图片2-10](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-10.png)
#####2、利用XCode的pragma分块特性提高定位效率  
![图片2-11](http://showmylym-blog.oss-cn-shenzhen.aliyuncs.com/2/2-11.png) 
